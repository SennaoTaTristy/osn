...
<html>
    ...
    <script defer>
        ...
        apps.messaging = {
            ...
            vars: {
                //appInfo: 'The official WOSP Messenger. Chat with the entire aOS community, all at once.<br><br>To set your name, go to Settings -&gt; 1, and enter a chat name.<br><br>To view past messages, go to Settings -&gt; 2, and enter in the number of past messages you wish to view.',
                discussionTopic: 'WOSP is on Discord! <a href="https://discord.gg/Y5Jytdm" target="_blank">https://discord.gg/Y5Jytdm</a>',
                lastMsgRecieved: '-9',
                nameTemp: 'Anonymous',
                name: 'Anonymous',
                xhttpDelay: 0,
