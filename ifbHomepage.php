...
<html>
    ...
    <body>
        ...
        <p>This app is intended for testing purposes. Its primary function is testing whether or not a webpage can load within an WOSP application.</p>
        <p>
            Some common reasons a webpage might not be able to load:
            <ul>
                <li>WOSP is loaded over HTTPS, but your webpage may have attempted to load over HTTP.</li>
